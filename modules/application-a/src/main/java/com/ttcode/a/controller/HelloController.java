package com.ttcode.a.controller;
...
public class HelloController {
    ...
    @Resource
    private RemoteApplicationBService remoteApplicationBService;

    @GetMapping("hello")
    public String hello(String params) {
        log.info("Hello this is application a, params: {}", params);
        String hello = remoteApplicationBService.hello("hello , it's a");
        log.info(hello);
        return "it's a , and you?";
    }
}
