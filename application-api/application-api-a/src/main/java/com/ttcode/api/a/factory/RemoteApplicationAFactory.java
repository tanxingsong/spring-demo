package com.ttcode.api.a.factory;


import com.ttcode.api.a.RemoteApplicationAService;
 ...
 */
@Component
public class RemoteApplicationAFactory implements FallbackFactory<RemoteApplicationAService> {
    Logger log = LoggerFactory.getLogger(RemoteApplicationAFactory.class);

    @Override
    public RemoteApplicationAService create(Throwable cause) {
        log.info("application a invoke error: {}", cause.getMessage());
        return new RemoteApplicationAService() {
            @Override
