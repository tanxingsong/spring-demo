package com.ttcode.api.a;

import com.ttcode.api.a.factory.RemoteApplicationAFactory;
 ...
 * @author tanxingsong
 */
@FeignClient(contextId = "RemoteApplicationAService", value = "application-a", fallback = RemoteApplicationAFactory.class)
public interface RemoteApplicationAService {
    @GetMapping("hello")
