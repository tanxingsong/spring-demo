package com.ttcode.api.c;

import com.ttcode.api.c.factory.RemoteApplicationCFactory;
 ...
 * @author tanxingsong
 */
@FeignClient(contextId = "RemoteApplicationCService", value = "application-c",fallbackFactory = RemoteApplicationCFactory.class)
public interface RemoteApplicationCService {
    @GetMapping("hello")
